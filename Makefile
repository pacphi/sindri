...
# Sindri v2 Makefile
# ============================================================================
# v2 (Bash + Docker) implementation Makefile. After the April 2026 reorg,
# this branch carries only v2 source. The v3-* targets remain temporarily
# (FIXME: trim them in a future PR) — they're inert here since v3/ doesn't
# exist on this branch.
#
# Quick Start:
#   make help          - Show all available targets
#   make v2-build      - Build the v2 Docker image
#   make v2-test       - Run v2 tests
#   make v2-ci         - Run full v2 CI suite
# ============================================================================
