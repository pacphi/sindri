...
| ------------------- | ------------ | ------------------------- | ------------------------------------------- |
| **Gemini CLI**      | `gemini`     | GOOGLE_GEMINI_API_KEY     | [GEMINI.md](docs/GEMINI.md)                 |
| **GitHub Copilot**  | `gh copilot` | GitHub CLI + subscription | [GITHUB_COPILOT.md](docs/GITHUB_COPILOT.md) |
| **AWS Q Developer** | `aws q`      | AWS CLI                   | [AWS_Q.md](docs/AWS_Q.md)                   |

### Local AI & Model Management

| Tool         | Command  | Description                           | Documentation               |
| ------------ | -------- | ------------------------------------- | --------------------------- |
| **Ollama**   | `ollama` | Run LLMs locally (no API key)         | [OLLAMA.md](docs/OLLAMA.md) |
| **Grok CLI** | `grok`   | Conversational AI CLI powered by Grok | [GROK.md](docs/GROK.md)     |
| **Fabric**   | `fabric` | AI pattern framework                  | [FABRIC.md](docs/FABRIC.md) |
...
**Full Documentation**: [DROID.md](docs/DROID.md)
...
**Full Documentation**: [GEMINI.md](docs/GEMINI.md)
...
**Full Documentation**: [GROK.md](docs/GROK.md)
...
See [DROID.md - Troubleshooting](docs/DROID.md#troubleshooting) for:
...
- **Factory AI**: [DROID.md](docs/DROID.md) - Complete Droid CLI documentation
- **Codex CLI**: [CODEX.md](docs/CODEX.md) - Complete Codex CLI guide
