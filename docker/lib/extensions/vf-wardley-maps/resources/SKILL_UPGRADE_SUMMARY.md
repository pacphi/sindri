...
```html
- Filter by Evolution Stage: Genesis/Custom/Product/Commodity - Filter by Insight Type:
Strengths/Vulnerabilities/Opportunities/Threats - Reset Zoom: Return to default view - Toggle Grid: Show/hide evolution
stages - Hover: View component details - Click: Pin component details panel
```
