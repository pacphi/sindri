...
**Architecture Decision:** See [ADR-001: Extension Capabilities System](./architecture/adr/001-extension-capabilities-system.md) for the design rationale behind optional capabilities (project-init, auth, hooks, mcp).
