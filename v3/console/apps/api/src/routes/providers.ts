...
const PROVIDERS = [
  {
    ...
    vm_sizes: [
      { id: 'shared-cpu-1x', name: 'Shared CPU 1x', vcpus: 1, memory_gb: 0.25, storage_gb: 1, price_per_hour: 0.0010 },
      { id: 'shared-cpu-2x', name: 'Shared CPU 2x', vcpus: 2, memory_gb: 0.5, storage_gb: 1, price_per_hour: 0.0020 },
      { id: 'performance-2x', name: 'Performance 2x', vcpus: 2, memory_gb: 4, storage_gb: 40, price_per_hour: 0.0500 },
      { id: 'performance-4x', name: 'Performance 4x', vcpus: 4, memory_gb: 8, storage_gb: 80, price_per_hour: 0.1000 },
      { id: 'performance-8x', name: 'Performance 8x', vcpus: 8, memory_gb: 16, storage_gb: 160, price_per_hour: 0.2000 },
    ],
  },
  {
    id: 'docker',
  ...
  },
  {
    ...
    vm_sizes: [
      { id: 'nano', name: 'Nano', vcpus: 2, memory_gb: 0.5, storage_gb: 1, price_per_hour: 0.0040 },
      { id: 'small', name: 'Small', vcpus: 2, memory_gb: 1, storage_gb: 5, price_per_hour: 0.0080 },
      { id: 'medium', name: 'Medium', vcpus: 4, memory_gb: 2, storage_gb: 10, price_per_hour: 0.0160 },
    ],
  },
  {
    id: 'kubernetes',
  ...
  },
  {
    ...
    vm_sizes: [
      { id: 'cpu-1x', name: 'CPU 1x', vcpus: 2, memory_gb: 4, storage_gb: 20, price_per_hour: 0.025 },
      { id: 'cpu-2x', name: 'CPU 2x', vcpus: 4, memory_gb: 8, storage_gb: 40, price_per_hour: 0.050 },
      { id: 'gpu-3090', name: 'RTX 3090', vcpus: 16, memory_gb: 24, storage_gb: 200, price_per_hour: 0.440 },
      { id: 'gpu-4090', name: 'RTX 4090', vcpus: 16, memory_gb: 24, storage_gb: 200, price_per_hour: 0.690 },
      { id: 'gpu-a100', name: 'A100 80GB', vcpus: 32, memory_gb: 80, storage_gb: 500, price_per_hour: 1.990 },
    ],
  },
] as const;
