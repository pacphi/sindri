...
describe('Alerting Engine: Alert History', () => {
  const history: AlertEvent[] = [
    makeAlertEvent({ id: 'alert_01', state: 'RESOLVED', firedAt: '2026-02-15T10:00:00Z', resolvedAt: '2026-02-15T10:15:00Z' }),
    makeAlertEvent({ id: 'alert_02', state: 'RESOLVED', firedAt: '2026-02-16T14:00:00Z', resolvedAt: '2026-02-16T14:05:00Z' }),
    makeAlertEvent({ id: 'alert_03', state: 'FIRING', firedAt: '2026-02-17T10:00:00Z', resolvedAt: null }),
  ];
