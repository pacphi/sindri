...
const instanceItems: PaletteItem[] = [
  {
    ...
    description: "fly / sea • RUNNING",
    keywords: ["python", "fly", "sea", "running"],
  },
  {
    id: "inst_02",
    type: "instance",
    title: "node-fullstack",
    description: "fly / iad • RUNNING",
    keywords: ["node", "typescript", "fly", "iad"],
  },
  {
    id: "inst_03",
    type: "instance",
    title: "rust-dev-01",
    description: "docker / local • STOPPED",
    keywords: ["rust", "docker", "stopped"],
  },
];
...
const actionItems: PaletteItem[] = [
  {
    ...
    description: "Open deployment wizard",
    keywords: ["create", "new", "wizard"],
  },
  {
    id: "act_import",
    type: "action",
