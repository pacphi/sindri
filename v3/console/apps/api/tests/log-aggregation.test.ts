...
const SAMPLE_LOGS: LogEntry[] = [
  makeLogEntry({ id: 'log_01', level: 'INFO', source: 'AGENT', message: 'Agent initialized', timestamp: '2026-02-17T10:00:00Z' }),
  makeLogEntry({ id: 'log_02', level: 'DEBUG', source: 'EXTENSION', message: 'Loading python3 extension', timestamp: '2026-02-17T10:00:01Z' }),
  makeLogEntry({ id: 'log_03', level: 'INFO', source: 'APP', message: 'Server listening on :8080', timestamp: '2026-02-17T10:00:05Z' }),
  makeLogEntry({ id: 'log_04', level: 'WARN', source: 'SYSTEM', message: 'High memory usage detected: 82%', timestamp: '2026-02-17T10:05:00Z' }),
  makeLogEntry({ id: 'log_05', level: 'ERROR', source: 'APP', message: 'Database connection failed: ECONNREFUSED', timestamp: '2026-02-17T10:10:00Z' }),
  makeLogEntry({ id: 'log_06', level: 'INFO', source: 'BUILD', message: 'Build step completed in 4.2s', timestamp: '2026-02-17T10:10:05Z' }),
  makeLogEntry({ id: 'log_07', level: 'ERROR', source: 'AGENT', message: 'Heartbeat to console failed', timestamp: '2026-02-17T10:15:00Z' }),
  makeLogEntry({ id: 'log_08', level: 'INFO', source: 'APP', message: 'Request completed: GET /health 200', timestamp: '2026-02-17T10:20:00Z' }),
];
...
describe('Log Aggregation: WebSocket Ingestion', () => {
  ...
  it('batch ingestion handles up to 1000 lines per message', () => {
    const lines = Array.from({ length: 1000 }, (_, i): LogLinePayload => ({
      level: 'info',
      message: `Log line ${i}`,
      source: 'agent',
      ts: Date.now(),
