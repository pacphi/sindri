...
export const usersApi = {
  ...
  getUserTeams(id: string): Promise<{
    teams: Array<{ teamId: string; teamName: string; role: string; joinedAt: string }>;
  }> {
...
export const teamsApi = {
  ...
  addMember(
    ...
    userId: string,
    role?: TeamMemberRole,
  ): Promise<{ teamId: string; userId: string; role: string; joinedAt: string }> {
  ...
  updateMemberRole(
    ...
    userId: string,
    role: TeamMemberRole,
  ): Promise<{ teamId: string; userId: string; role: string }> {
  ...
  getInstances(
    teamId: string,
  ): Promise<{ instances: Array<{ id: string; name: string; provider: string; status: string }> }> {
