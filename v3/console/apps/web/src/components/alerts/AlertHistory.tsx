...
import { AlertTriangle, CheckCircle, Clock, EyeOff, Filter, RefreshCw, Check } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button variant="ghost" size="sm" onClick={() => refetch()} className="gap-2 text-gray-400">
        ...
        <div className="grid grid-cols-2 gap-3 rounded-lg border border-gray-800 bg-gray-900 p-4 sm:grid-cols-4">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFilters((f) => ({ ...f, status: (e.target.value as AlertStatus) || undefined }))
              }
