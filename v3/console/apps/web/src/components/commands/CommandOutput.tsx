...
function ansiToHtml(text: string): string {
  const ANSI_COLORS: Record<string, string> = {
    '30': '#374151', '31': '#ef4444', '32': '#22c55e', '33': '#f59e0b',
    ...
    <div className={cn('rounded-md border bg-[#0d1117] font-mono text-sm', className)}>
      ...
      {execution.stdout && (
        <div className="overflow-x-auto">
          <div
            ref={stdoutRef}
            className="whitespace-pre p-3 text-gray-200 leading-relaxed"
          />
        </div>
      )}
      ...
      {execution.stderr && (
        <div className="overflow-x-auto border-t border-red-900/40">
          ...
          <div
            ref={stderrRef}
            className="whitespace-pre p-3 pt-0 text-red-300 leading-relaxed"
          />
        </div>
      )}
