    ...
    <Card className={cn("", className)}>
      ...
      <CardContent className="pt-0">
        {isLoading ? (
          ...
          <p className="text-sm text-muted-foreground text-center py-4">Failed to load events</p>
        ) : events.length === 0 ? (
          ...
          <div className="divide-y divide-border" role="list" aria-label="Instance event timeline">
            {events.map((event) => (
