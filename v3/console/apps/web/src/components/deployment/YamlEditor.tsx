    ...
    const completionProvider = monaco.languages.registerCompletionItemProvider("yaml", {
      ...
      provideCompletionItems(model, position) {
        ...
        const prevLineContent =
          position.lineNumber > 1 ? model.getLineContent(position.lineNumber - 1) : "";
        ...
        if (lineIndent === 0) {
          const topLevelKeys: Array<{ key: string; snippet: string; doc: string }> = [
            ...
            {
              key: "name",
              snippet: "name: my-instance",
              doc: "Deployment name (lowercase, alphanumeric, hyphens)",
            },
            {
              key: "deployment",
              snippet: "deployment:\n  provider: docker",
