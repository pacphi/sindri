...
const MOCK_VM_SIZES: VmSize[] = [
  { id: 'shared-cpu-1x', name: 'Shared CPU 1x', vcpus: 1, memory_gb: 1, storage_gb: 10, price_per_hour: 0.01 },
  { id: 'shared-cpu-2x', name: 'Shared CPU 2x', vcpus: 2, memory_gb: 2, storage_gb: 20, price_per_hour: 0.02 },
  { id: 'performance-2x', name: 'Performance 2x', vcpus: 2, memory_gb: 4, storage_gb: 40, price_per_hour: 0.05 },
  { id: 'performance-4x', name: 'Performance 4x', vcpus: 4, memory_gb: 8, storage_gb: 80, price_per_hour: 0.10 },
  { id: 'performance-8x', name: 'Performance 8x', vcpus: 8, memory_gb: 16, storage_gb: 160, price_per_hour: 0.20 },
  { id: 'performance-16x', name: 'Performance 16x', vcpus: 16, memory_gb: 32, storage_gb: 320, price_per_hour: 0.40 },
]
        ...
        <div className="grid grid-cols-2 gap-3">
          {MOCK_VM_SIZES.map((size) => (
            <Card
              ...
              onClick={() => onChange({ vmSize: size.id, memoryGb: size.memory_gb, storageGb: size.storage_gb })}
            >
              ...
              <CardContent className="p-3 pt-0">
                ...
                <p className="text-xs font-medium mt-1">
                  ${size.price_per_hour.toFixed(3)}/hr
                </p>
              </CardContent>
            </Card>
          ))}
        ...
        {selectedVmSize && (
          <div className="mt-3 p-3 bg-muted rounded-md">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              {selectedVmSize.vcpus} vCPUs · {selectedVmSize.memory_gb} GB RAM · {selectedVmSize.storage_gb} GB storage
