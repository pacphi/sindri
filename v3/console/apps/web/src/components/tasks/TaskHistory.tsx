...
const STATUS_CONFIG: Record<
  ExecutionStatus,
  { icon: React.ReactNode; variant: 'success' | 'error' | 'warning' | 'muted' | 'info'; label: string }
> = {
  ...
  RUNNING: { icon: <Loader2 className="h-3.5 w-3.5 animate-spin" />, variant: 'info', label: 'Running' },
  ...
  TIMED_OUT: { icon: <AlertCircle className="h-3.5 w-3.5" />, variant: 'warning', label: 'Timed Out' },
}
