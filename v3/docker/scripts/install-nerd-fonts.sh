...
# Reduced to 3 most popular fonts to minimize image size (~75% reduction)
FONTS=(
    "FiraCode"        # Most popular, excellent ligatures, widely used
    "CascadiaCode"    # Microsoft's modern coding font (CaskaydiaCove is the patched name)
    "Meslo"           # Popular alternative, Apple-inspired (MesloLG downloads as Meslo)
)
