...
Per the [Rust Migration Plan v3](../../planning/complete/rust-cli-migration-v3.md), Phases 2 & 3 encompass:
...
- Migration Plan: [docs/planning/complete/rust-cli-migration-v3.md](../../planning/complete/rust-cli-migration-v3.md)
- Workspace: `sindri-rs/`
