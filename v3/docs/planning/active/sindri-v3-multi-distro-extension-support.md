...
7. [Extension Migration Plan](#7-extension-migration-plan)
   - [7.1 Tier 1: No Changes Required](#71-tier-1-no-changes-required)
   - [7.2 Tier 2: Add `distros` Declaration Only](#72-tier-2-add-distros-declaration-only)
   - [7.3 Tier 3: Per-Distro Install Config](#73-tier-3-per-distro-install-config)
   - [7.4 Tier 4: Script Rewrite Required](#74-tier-4-script-rewrite-required)
